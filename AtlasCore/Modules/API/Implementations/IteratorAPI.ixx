...
export namespace Atlas
{
	...
	public:
		...
		constexpr static inline auto Current
			(
		...
		template<typename TIterator>
		constexpr static inline bool Move
			(
				TIterator& iterator ,
				const int step
			)
		...
		template<typename TIterator>
		constexpr static inline bool Next
			( 
				TIterator& iterator 
			)
			noexcept ( Concept::IsNoexceptMove<TIterator&> )
		...
		template<typename TIterator>
		constexpr static inline bool Previous
			( 
				TIterator& iterator
			)
			noexcept ( Concept::IsNoexceptMove<TIterator&> )
		...
		constexpr static inline auto At
			( 
		...
		template<typename TCollection>
		constexpr static inline auto ConstAt
			( 
				const TCollection& collection ,
				const unsigned int index 
			)
		...
		template<typename TCollection>
		constexpr static inline auto Begin
			( 
				const TCollection& collection 
			)
		...
		template<typename TCollection>
		constexpr static inline auto ConstBegin
			(
				const TCollection& collection
			)
		...
		template<typename TCollection>
		constexpr static inline auto End
			( 
				const TCollection& collection
			)
		...
		template<typename TCollection>
		constexpr static inline auto ConstEnd
			( 
				const TCollection& collection 
			)
