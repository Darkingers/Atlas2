...
export namespace Atlas
{
	class DLLApi Vector
	{
		...
		constexpr static bool IsNoexceptBegin = noexcept ( std::begin( std::declval<std::vector<DataType>>( ) ) );
		private: template<typename DataType>
		constexpr static bool IsNoexceptEnd = noexcept ( std::cend( std::declval<std::vector<DataType>>( ) ) );
		private: template<typename DataType>
		constexpr static bool IsNoexceptErase = noexcept ( std::declval<std::vector<DataType>>( ).erase( std::declval<typename std::vector<DataType>::iterator>( ) ) );
		private: template<typename DataType>
		constexpr static bool IsNoexceptFindif = noexcept ( std::find_if( std::declval<typename std::vector<DataType>::iterator>( ) , std::declval<typename std::vector<DataType>::iterator>( ) , std::declval<DataType>( ) ) );
		private: template<typename DataType>
		constexpr static bool IsNoexceptFind = noexcept ( std::find( std::declval<typename std::vector<DataType>::iterator>( ) , std::declval<typename std::vector<DataType>::iterator>( ) , std::declval<DataType>( ) ) );
		private: template<typename DataType>
		constexpr static bool IsNoexceptInsert = noexcept ( std::declval<std::vector<DataType>>( ).insert( std::declval<typename std::vector<DataType>::iterator>( ) , std::declval<DataType>( ) ) );
		private: template<typename DataType>
		constexpr static bool IsNoexceptPushback = noexcept ( std::declval<std::vector<DataType>>( ).push_back( std::declval<DataType>( ) ) );
		private: template<typename DataType>
		...
		private: template<typename DataType>
		constexpr static bool IsNoexceptSize = noexcept ( std::declval<std::vector<DataType>>( ).size( ) );
		private: template<typename DataType>
		constexpr static bool IsNoexceptEmpty = noexcept ( std::declval<std::vector<DataType>>( ).empty( ) );
		private: template<typename DataType>
		constexpr static bool IsNoexceptCount = noexcept ( std::count( std::declval<typename std::vector<DataType>::iterator>( ) , std::declval<typename std::vector<DataType>::iterator>( ) , std::declval<DataType>( ) ) );
		...
		constexpr static void SortBy( std::vector<DataType>& vector , Definition::Comparator<DataType> comparator )
			noexcept ( IsNoexceptBegin<DataType> && IsNoexceptEnd<DataType>&& IsNoexceptSort<DataType> && noexcept ( std::declval<Definition::Comparator<DataType>>()( std::declval<DataType>( ) , std::declval<DataType>( ) ) ) )
		{
		...
		constexpr static auto GroupBy( const std::vector<DataType>& vector , Definition::KeyGenerator<DataType, KeyType> keyGenerator )
			noexcept ( IsNoexceptBegin<DataType> && IsNoexceptEnd<DataType> && IsNoexceptPushback<DataType> && noexcept ( std::declval<Definition::KeyGenerator<DataType , KeyType>>( )( std::declval<DataType>( ) ) ) && noexcept ( std::declval<std::map<KeyType , std::vector<DataType>>>( ).insert( std::declval<std::pair<KeyType , std::vector<DataType>>>( ) ) ) )
		{
		...
		constexpr static auto CountIf( const std::vector<DataType>& vector , Definition::Condition<DataType> condition )
			noexcept ( IsNoexceptBegin<DataType> && IsNoexceptEnd<DataType> && noexcept ( std::declval<Definition::Condition<DataType>>( )( std::declval<DataType>( ) ) ) && noexcept ( std::count_if( std::declval<typename std::vector<DataType>::iterator>( ) , std::declval<typename std::vector<DataType>::iterator>( ) , std::declval<Definition::Condition<DataType>>( ) ) ) )
		{
		...
		constexpr static auto ContainsIf( const std::vector<DataType>& vector , Definition::Condition<DataType> condition )
			noexcept ( IsNoexceptBegin<DataType>&& IsNoexceptEnd<DataType> && noexcept ( std::declval<Definition::Condition<DataType>>( )( std::declval<DataType>( ) ) ) && noexcept ( std::find_if( std::declval<typename std::vector<DataType>::iterator>( ) , std::declval<typename std::vector<DataType>::iterator>( ) , std::declval<Definition::Condition<DataType>>( ) ) ) )
		{
