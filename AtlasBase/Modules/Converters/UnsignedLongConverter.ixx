...
export namespace Atlas::Converters
{
	...
	{
		public: constexpr static bool IsNoexcept = noexcept( static_cast<unsigned long>( std::declval<SourceType>( ) ) );
	...
	class DLLApi Converter<std::string , unsigned long> :
		public std::true_type
	{
		public: constexpr static bool IsNoexcept = noexcept( std::stoul( std::declval<std::string>( ) ) );
	...
	class DLLApi Converter<const char* , unsigned long> :
		public std::true_type
	{
		public: constexpr static bool IsNoexcept = noexcept( std::stoul( std::declval<const char*>( ) ) );
