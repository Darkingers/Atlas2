...
export module AtlasVariadicHelpers:ContainChecker;
...
export namespace Atlas::Variadics
{
	...
	class DLLApi ContainChecker
	{
		...
		constexpr static inline bool AnyContains(const DataType& data, const DataType& current, const Args&... arguments)
		{
		...
		constexpr static inline bool AllContains(const DataType& data, const DataType& current , const Args&... arguments )
		{
			const bool equals = ( data == current );		
		...
		constexpr static inline bool AnyContains(const DataType& data, const CollectionType& collection, const Args&... arguments )
		{
		...
		public: template<typename CollectionType, typename... Args>
		constexpr static inline bool AllContains(const DataType& data , const CollectionType& collection , const Args&... arguments )
		{
			const bool contains = Adapter::Contains( collection , data );
