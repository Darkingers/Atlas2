...
export namespace Atlas::Converters
{
	...
	{
		public: constexpr static bool IsNoexcept = noexcept( std::to_string( std::declval<unsigned long long>( ) ) );
	...
	class DLLApi Converter<SourceType , std::string> :
		public std::true_type
	{
		public: constexpr static bool IsNoexcept = noexcept( std::declval<SourceType>( ).ToString( ));
	...
	class DLLApi Converter<int, std::string> :
		public std::true_type
	{
		public: constexpr static bool IsNoexcept = noexcept( std::to_string( std::declval<int>( ) ));
	...
	class DLLApi Converter<unsigned int, std::string> :
		public std::true_type
	{
		public: constexpr static bool IsNoexcept = noexcept( std::to_string( std::declval<unsigned int>( ) ));
	...
	class DLLApi Converter<long , std::string> :
		public std::true_type
	{
		public: constexpr static bool IsNoexcept = noexcept( std::to_string( std::declval<long>( ) ));
	...
	class DLLApi Converter<unsigned long , std::string> :
		public std::true_type
	{
		public: constexpr static bool IsNoexcept = noexcept( std::to_string( std::declval<unsigned long>( ) ) );
	...
	class DLLApi Converter<long long , std::string> :
		public std::true_type
	{
		public: constexpr static bool IsNoexcept = noexcept( std::to_string( std::declval<long long>( ) ) );
	...
	class DLLApi Converter<float , std::string> :
		public std::true_type
	{
		public: constexpr static bool IsNoexcept = noexcept( std::to_string( std::declval<float>( ) ) );
	...
	class DLLApi Converter<double , std::string> :
		public std::true_type
	{
		public: constexpr static bool IsNoexcept = noexcept( std::to_string( std::declval<double>( ) ) );
	...
	class DLLApi Converter<long double , std::string> :
		public std::true_type
	{
		public: constexpr static bool IsNoexcept = noexcept( std::to_string( std::declval<long double>( ) ) );
	...
	class DLLApi Converter<bool, std::string> :
		public std::true_type
	{
		public: constexpr static bool IsNoexcept = noexcept( std::to_string( std::declval<bool>( ) ) );
	...
	class DLLApi Converter<char*, std::string> :
		public std::true_type
	{
		public: constexpr static bool IsNoexcept = noexcept( std::string( std::declval<char*>( ) ) );
